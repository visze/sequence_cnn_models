...
Report bugs at https://github.com/kircherlab/sequence_cnn_models/issues
...
Sequence CNN Models could always use more documentation, even on the web in blog posts, articles, and such.

Sequence CNN Models uses `Sphinx <https://www.sphinx-doc.org>`_ for the user documentation (that you are currently reading).
...
The best way to send feedback is to file an issue at https://github.com/kircherlab/sequence_cnn_models/issues
...
Use the following steps for installing Sphinx and the dependencies for building the Sequence CNN Models documentation:

.. code-block:: bash

    cd sequence_cnn_models/docs
...
1. Fork the `sequence_cnn_models` repo on GitHub (master branch).
2. Clone your fork locally::

    git clone git@github.com:your_name_here/sequence_cnn_models.git
